package dev.subfly.baseandroidcomposektor.featureDetail.data.repository

import dev.subfly.baseandroidcomposektor.core.data.dto.CoinDto
import dev.subfly.baseandroidcomposektor.featureDetail.domain.dao.CoinPaprikaDetailDao
